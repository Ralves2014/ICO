...
errodf=1e-1;   % É INDICADO O ERRO (errodf) PERMITIDO NO GRADIENte: 10^(-1)
...
NPontosIniciais=15; %É INDICADO O Nº (NPontosIniciais) DE PTOS INICIAIS: 10 

a=[-2.5,-2.5]'; b=[6.5,6.5]'; % É INDICADO O INTERVALO DE VISUALIZAÇÃO GRÁ- 
...
%                                NESTE CASO É POR GERAÇÃO PSEUDO-ALEATÓRIA
    lambda=.01;           % ESCOLHA DO PASSO / STEPSIZE CONST. LAMBDA: 0.01
